...
class BluetoothSerialESP32:
    ...
    def __init__(self, port, baudrate=115200, n_vars=1):
        """
    ...
    def start(self):
        ...
        try:
            ...
            print(f"Opened Bluetooth serial port {self.port} with baudrate {self.baudrate}")
            ...
            print(f"Error opening Bluetooth serial port: {e}")
    ...
    def stop(self):
        ...
        if self.serial_port is not None:
            ...
            print(f"Closed Bluetooth serial port {self.port}")
